// 本文件基于上游 bpking1/embyExternalUrl v1.2.1（embyWebAddExternalUrl/embyLaunchPotplayer.js），
// 仅做两处本地适配，升级时同步上游后重做以下修改：
//   1. iconConfig.baseUrl 改为 "css/icons"（amilys/embyserver 镜像自带图标目录），禁用 jsdelivr 外链；
//   2. getIconsExt() 内嵌 iconsExt.js 的 base64 图标（优先级最高，完全离线）。
// ==UserScript==
...
(function () {
    ...
    const iconConfig = {
        ...
        // 2.server local icons, amilys/embyserver ships them at /system/dashboard-ui/css/icons
        baseUrl: "css/icons",
