  ...
  cat > "$CLAUDE_SETTINGS" <<EOF
{
  ...
  "env": {
    ...
    "ANTHROPIC_DEFAULT_FABLE_MODEL": "kimi-k2.7[1M]",
    "ANTHROPIC_DEFAULT_FABLE_MODEL_NAME": "kimi-k2.7",
    "ANTHROPIC_DEFAULT_HAIKU_MODEL": "glm-5-turbo",
    "ANTHROPIC_DEFAULT_HAIKU_MODEL_NAME": "glm-5-turbo",
    "ANTHROPIC_DEFAULT_OPUS_MODEL": "gpt-5.5-high[1M]",
    "ANTHROPIC_DEFAULT_OPUS_MODEL_NAME": "gpt-5.5-high",
