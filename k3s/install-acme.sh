...
kube_secret_load "cert-manager" "${DOMAIN}-alidns-secret" \
...
if [ "$INSTALL_MODE" == "reinstall" ]; then
    helm_ensure_chart "cert-manager-alidns-webhook" "https://devmachine-fr.github.io/cert-manager-alidns-webhook" "alidns-webhook" "temp"
else
    VERSION_PAIR=$(helm_chart_versions "cert-manager-alidns-webhook" "https://devmachine-fr.github.io/cert-manager-alidns-webhook" "alidns-webhook")
    read -r CHART_VERSION APP_VERSION <<<"$VERSION_PAIR"
    helm_ensure_chart "cert-manager-alidns-webhook" "https://devmachine-fr.github.io/cert-manager-alidns-webhook" "alidns-webhook" "temp" "$CHART_VERSION"
fi
